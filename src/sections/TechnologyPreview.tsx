  ...
  return (
    <section className="section technology-preview">
      <div className="container technology-preview__grid">
        <div className="tech-editorial scroll-animate" aria-label="Tecnologia ReViva">
          <span>01 / Tecnologia</span><strong>Realidade<br />Virtual</strong><i>interação</i><b>dados</b><em>cuidado</em>
        </div>
        <div>
