...
export function Technology() {
  ...
  return <>
    <PageHero eyebrow="Tecnologia ReViva" title={<>Imersão com um objetivo <em>muito real.</em></>} copy="Uma plataforma em desenvolvimento que conecta experiências em Realidade Virtual a uma visão mais contextual do desempenho." action={{ label: 'Conheça a solução', href: '/solucao' }}>
      <div className="tech-hero-art"><div className="tech-hero-art__sphere"><i /><i /><i /><b>R</b></div><span className="tech-hero-art__dash"><small>interações</small><strong>capturadas</strong><i /><i /><i /></span><span className="tech-hero-art__node tech-hero-art__node--one" /><span className="tech-hero-art__node tech-hero-art__node--two" /></div>
    </PageHero>
    ...
    <section className="section system-flow"><div className="container"><SectionHeader eyebrow="Fluxo da solução" title={<>Da experiência ao <em>acompanhamento.</em></>} centered /><div className="system-flow__items"><div><Icon name="user" size={25} /><span>Paciente</span></div><i /><div><Icon name="headset" size={25} /><span>Headset VR</span></div><i /><div className="system-flow__center"><b>R</b><span>Experiência<br />ReViva</span></div><i /><div><Icon name="data" size={25} /><span>Coleta de dados</span></div><i /><div><Icon name="barChart" size={25} /><span>Acompanhamento</span></div></div><p className="system-flow__caption">A coleta e a visualização de métricas fazem parte da visão de desenvolvimento da solução.</p></div></section>
