...
export function About() {
  ...
  return <>
    <PageHero eyebrow="Sobre a ReViva" title={<>Tecnologia com propósito <em>humano.</em></>} copy="A ReViva nasce da vontade de tornar a reabilitação uma experiência mais participativa, envolvente e possível de acompanhar." action={{ label: 'Fale com a ReViva', href: '/contato' }}>
      <div className="about-hero-art"><span className="about-hero-art__circle about-hero-art__circle--one" /><span className="about-hero-art__circle about-hero-art__circle--two" /><div className="about-hero-art__seed"><i /><i /><i /></div><span className="about-hero-art__label">movimento<br />que renova</span></div>
    </PageHero>
